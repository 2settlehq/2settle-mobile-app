...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF4472C4);
  late Color secondary = const Color(0xFF4587B4);
  late Color tertiary = const Color(0xFF6E99E2);
  late Color alternate = const Color(0xFF067AEF);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF6E99E2);
...
extension TextStyleHelper on TextStyle {
  TextStyle override({
    ...
    return font != null
        ? font.copyWith(
            fontFamily: fontFamily ?? font.fontFamily ?? 'Inter',
            fontFamilyFallback:
                font.fontFamilyFallback ?? const ['Roboto', 'Arial'],
